...
(cl:in-package arlo_nn_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arlo_nn_controller-msg:<Num> is deprecated: use arlo_nn_controller-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arlo_nn_controller-msg:num-val is deprecated.  Use arlo_nn_controller-msg:num instead.")
  (num m))
